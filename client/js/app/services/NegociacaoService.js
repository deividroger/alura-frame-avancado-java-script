...
System.register(['./HttpService', './ConnectionFactoryService', '../dao/NegociacaoDao', '../models/Negociacao'], function (_export, _context) {
    "use strict";

    var HttpService, ConnectionFactoryService, NegociacaoDao, Negociacao, _createClass, NegociacaoService;
    ...
    return {
        ...
        }, function (_ConnectionFactoryService) {
            ConnectionFactoryService = _ConnectionFactoryService.ConnectionFactoryService;
            ...
            _export('NegociacaoService', NegociacaoService = function () {
                ...
                _createClass(NegociacaoService, [{
                    ...
                    value: function cadastra(negociacao) {
                        ...
                        return ConnectionFactoryService.getConnection().then(function (connection) {
